...
describe "App" do
  context "when calling root route" do
    ...
    it "returns default questions" do
      JSON.parse(api_response.body).should eq(
        {
          "q" => "Are you a robot ?",
          "a" => [
  ...
  context "when visiting english route" do
    ...
    it "returns a question" do
      JSON.parse(api_response("en").body).should eq(
        {
          "q" => "Are you a robot ?",
          "a" => [
            "68934a3e9455fa72420237eb05902327",
  ...
  context "when visiting french route" do
    it "returns a success response" do
      api_response("fr").status_code.should eq(200)
    end

    it "returns default questions" do
      JSON.parse(api_response("fr").body).should eq(
        {
          "q" => "Êtes-vous une machine ?",
          "a" => [
            "14b8f0494c6f1460c3720d0ce692dbca",
  ...
  context "when visiting a route that is not defined" do
    ...
    it "returns default questions" do
      JSON.parse(api_response("ys").body).should eq(
        {
          "q" => "Are you a robot ?",
          "a" => [
            "68934a3e9455fa72420237eb05902327",
